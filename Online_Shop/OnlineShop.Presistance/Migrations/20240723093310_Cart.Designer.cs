            ...
            modelBuilder.Entity("OnlineShop.domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2024, 7, 23, 13, 3, 10, 500, DateTimeKind.Local).AddTicks(105),
                            IsRemoved = false,
                            name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2024, 7, 23, 13, 3, 10, 500, DateTimeKind.Local).AddTicks(153),
                            IsRemoved = false,
                            name = "Oprator"
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2024, 7, 23, 13, 3, 10, 500, DateTimeKind.Local).AddTicks(165),
                            IsRemoved = false,
                            name = "Customer"
                        });
                });
