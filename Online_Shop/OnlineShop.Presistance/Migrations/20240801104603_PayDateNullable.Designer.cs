...
namespace OnlineShop.Presistance.Migrations
{
    ...
    [Migration("20240801104603_PayDateNullable")]
    partial class PayDateNullable
    {
            ...
            modelBuilder.Entity("OnlineShop.domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2024, 8, 1, 14, 16, 2, 587, DateTimeKind.Local).AddTicks(7757),
                            IsRemoved = false,
                            name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2024, 8, 1, 14, 16, 2, 587, DateTimeKind.Local).AddTicks(7836),
                            IsRemoved = false,
                            name = "Oprator"
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2024, 8, 1, 14, 16, 2, 587, DateTimeKind.Local).AddTicks(7862),
                            IsRemoved = false,
                            name = "Customer"
                        });
                });
