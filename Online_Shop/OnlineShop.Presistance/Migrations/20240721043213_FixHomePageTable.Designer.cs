...
namespace OnlineShop.Presistance.Migrations
{
    ...
    [Migration("20240721043213_FixHomePageTable")]
    partial class FixHomePageTable
    {
            ...
            modelBuilder.Entity("OnlineShop.domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2024, 7, 21, 8, 2, 12, 831, DateTimeKind.Local).AddTicks(1051),
                            IsRemoved = false,
                            name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2024, 7, 21, 8, 2, 12, 831, DateTimeKind.Local).AddTicks(1110),
                            IsRemoved = false,
                            name = "Oprator"
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2024, 7, 21, 8, 2, 12, 831, DateTimeKind.Local).AddTicks(1129),
                            IsRemoved = false,
                            name = "Customer"
                        });
                });
