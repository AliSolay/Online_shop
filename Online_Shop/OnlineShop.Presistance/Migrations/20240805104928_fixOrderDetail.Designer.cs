...
namespace OnlineShop.Presistance.Migrations
{
    ...
    [Migration("20240805104928_fixOrderDetail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Finance.RequestPay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.HomePages.HomePageImage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("OnlineShop.domain.Entities.HomePages.Slider", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Orders.OrderDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("OnlineShop.domain.Entities.Products.ProductFeatures", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("OnlineShop.domain.Entities.Products.ProductImage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("OnlineShop.domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2024, 8, 5, 14, 19, 27, 230, DateTimeKind.Local).AddTicks(1665),
                            IsRemoved = false,
                            name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2024, 8, 5, 14, 19, 27, 230, DateTimeKind.Local).AddTicks(1706),
                            IsRemoved = false,
                            name = "Oprator"
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2024, 8, 5, 14, 19, 27, 230, DateTimeKind.Local).AddTicks(1719),
                            IsRemoved = false,
                            name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Orders.Order", b =>
                {
                    b.HasOne("OnlineShop.Domain.Entities.Finance.RequestPay", "RequestPay")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("OnlineShop.domain.Entities.Products.Category", b =>
                {
                    b.HasOne("OnlineShop.domain.Entities.Products.Category", "ParentCategory")
