...
namespace OnlineShop.Presistance.Migrations
{
    ...
    [Migration("20240725080724_fixInventoryType")]
    partial class fixInventoryType
    {
            ...
            modelBuilder.Entity("OnlineShop.domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2024, 7, 25, 11, 37, 23, 489, DateTimeKind.Local).AddTicks(8909),
                            IsRemoved = false,
                            name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2024, 7, 25, 11, 37, 23, 489, DateTimeKind.Local).AddTicks(8961),
                            IsRemoved = false,
                            name = "Oprator"
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2024, 7, 25, 11, 37, 23, 489, DateTimeKind.Local).AddTicks(8973),
                            IsRemoved = false,
                            name = "Customer"
                        });
                });
